...
/**
 * Interface to the Superuser shell on Android devices with some helper functions.
 * <p/>
 * <p/>
 ...
 * <p/>
 * <p/>
 * To run command with standard shell (no root permissions): <code>ShellInterface.setShell("sh");</code>
 * <p/>
