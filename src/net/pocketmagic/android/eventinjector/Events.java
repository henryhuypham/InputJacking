...
public class Events {
	...
	public class InputDevice {
		...
		final int	EV_KEY	= 0x01, EV_REL = 0x02, EV_ABS = 0x03, REL_X = 0x00, REL_Y = 0x01, REL_Z = 0x02, BTN_TOUCH = 0x14a;	// 330
		 ...
		 * 
		 * @param forceOpen
		 *            will try to set permissions and then reopen if first open attempt fails
	...
	public int rawSendEvent(int devid, int type, int code, int value) {
		return intSendEvent(devid, type, code, value);
	}
